...
namespace longlp {
  ...
  TEST(InstrumentFeedsWorker, InvalidBook) {
  ...
  TEST(InstrumentFeedsWorker, AddNewBook) {
    InstrumentFeedsWorker worker{};
    const std::vector<std::string> expected = {""};
  ...
  TEST(InstrumentFeedsWorker, PartialAgressive) {
    InstrumentFeedsWorker worker{};
    const std::vector<std::string> expected = {
      "",
  ...
  TEST(InstrumentFeedsWorker, FullAgressive) {
    InstrumentFeedsWorker worker{};
    const std::vector<std::string> expected = {
      "",
  ...
  TEST(InstrumentFeedsWorker, HomeTestExample) {
    InstrumentFeedsWorker worker{};
    const std::vector<std::string> expected = {
      "",
